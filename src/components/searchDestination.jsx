    ...
    <>
      <form className="flex flex-col text-center items-center bg-[#252527] text-white px-5 md:px-8 py-5 gap-3 rounded-md w-full">
        ...
        <div className="flex md:flex-row flex-col w-full items-center">
          ...
          <button type="submit" className="flex flex-col items-center border-[#ffffff55] md:border-white p-2 mt-3 md:mt-0 md:ml-2 border-solid border-[1px] md:border-2 md:aspect-square rounded-[8px] hover:bg-[#ffffff22] w-full md:w-fit" >
